...
#define FASTSIZEBOUND 240000	//	for matrix size smaller than this, store the whole thing for speed	//
...
//				gradz = cal_interpgrad(3, zstarx, zstary, zstarz);
				cal_interpgrad(N, H, zstarx, zstary, zstarz, DIST_DX, DIST_DY, DIST_DZ, \
					&gradx, &grady, &gradz);
...
//					gradz[counti] = cal_interpgrad(3, tstarx, tstary, tstarz);
					...
					cal_interpgrad(N, H, tstarx, tstary, tstarz, DIST_DX, DIST_DY, DIST_DZ, \
...
//			gradz[counti] = cal_interpgrad(3, tstarx, tstary, tstarz);
			...
			cal_interpgrad(N,H,tstarz, tstary, tstarz, DIST_DX, DIST_DY, DIST_DZ, \
					&gradx[counti], &grady[counti], &gradz[counti]);
